...
int main()
{
 while(1)
 {
   int fd = open("/opt/nvidia/deepstream/deepstream-6.0/sources/deepstream_python_apps/apps/deepstream-test7/internal_memory.txt",O_RDONLY);
  ...
  //  char true_true_data[data_len-10] = {0};
   memcpy(true_data, addr, data_len+6);
